...
**Status:** promoted  
**Owner:** Agent R2  
**Params prefix:** `mpairs_*` (production defaults on)  
**Kill rule:** 3 consecutive non-promotable ticks → freeze  
**Floor:** minimal core + `mpairs=40@0.20k3z1.50c0.65`  
...
| Lead promote | Reconfirmed tick-1 winner against the minimal-core research floor | 221.91 | 293.41 | 171.47 | 292.15 | PROMOTED — higher of two promotable tracks; production reset intentionally |
